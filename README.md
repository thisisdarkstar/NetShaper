# ⚡ DARKSTAR NETSHAPER (PySide6 Bandwidth Regulating Suite)
...
- **⏳ Token Bucket Shapping**: Smooth, modern multi-threaded token bucket bandwidth regulation with zero rate stuttering.
- **⚡ Hardware-Accelerated PySide6 UI**: High-impact UI featuring curated dark HSL palettes, clean layouts, and micro-animated slider toggles.
- **🔒 Persistent Policies**: Save, load, and edit bandwidth cap rules (Download / Upload limits in KB/s, MB/s, Mbps, or Kbps) stored in a lightweight JSON database.
